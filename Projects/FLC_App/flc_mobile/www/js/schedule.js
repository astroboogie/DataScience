                ...
                if (subjects[currentTitle] == selectedSubject) {
                    $.each(element['classTimes'], function(key, value) {
                        ...
                        if (validCourse) {
                            ...
                            $("#courses").append(
                                "<div id='" + value['classNum'] + "' class='course-object'>\
                                    <div class='course-text-container'>\
                                        <div class='course-title'>\
                                            <span>" + element['courseTitle'] + ": " + element['courseName'] + courseType + "</span>\
                                        </div>\
                                        <div class='course-description'>\
                                            <div class='course-days'>" + value['days'] + "</div>\
                                            <div class='course-time'>" + selectedTime + "</div>\
                                            <div class='course-professor'>" + value['instructor'] + "</div>\
                                        </div>\
